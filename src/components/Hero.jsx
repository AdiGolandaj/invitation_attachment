  ...
  return (
    <div className='bg-lblu w-screen h-96 flex flex-col justify-center items-center p-7'>
        <div className='flex justify-center items-center gap-6 mb-4 '>
            <img src="./img/pegLogo.png" alt="" className='h-16 w-auto rounded-lg' />
            <img src="./img/NAACBpplogo.png" alt="" className='h-16 w-auto rounded-lg' />
            <img src="./img/ISBMlogo.jpeg" alt="" className='h-16 w-auto rounded-lg' />
        </div>
